...
int main() {
    ...
    std::future<int> pi1_rc_future = std::async(execute_command, pi1_channel, "cat pi1_output.txt");
    ...
    std::future<int> pi2_rc_future = std::async(execute_command, pi2_channel, "cat pi2_output.txt");
